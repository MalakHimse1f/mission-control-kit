...
export function getStageVendorSkills(workflowType, stage) {
...
export function resolveDispatch(workflowType, stage) {
  ...
  const vendorSkills = getStageVendorSkills(workflowType, stage);
...
export function buildContextPacket({ workflowType, stage, subagent, slug, controlRoot, taskId }) {
  ...
  return {
    ...
    read,
    skip,
    skills: getStageVendorSkills(workflowType, stage),
    invoke: base?.invoke ?? [],
    outputs: [],
    stop: 'DONE',
  };
