 ...
 *
 * File layout: `{controlRoot}/features/{slug}/decisions.json`
 ...
 * - `controlRoot` defaults to nearest `control/v5/` walking up from process.cwd().
...
function featurePath(controlRoot, slug) {
  return path.join(controlRoot, 'features', slug, 'decisions.json');
}
