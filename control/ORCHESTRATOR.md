...
- `JOURNAL-RULES.md`
- `AGENT-DATA-RULES.md`
- `layout/selection/SELECTION-UI.md` — research HTML outputs + present-to-user rules
...
5. **If stage produced research HTML** (explore, research, strategy, interaction) → **present files to the user in chat** with viewing instructions per `layout/selection/SELECTION-UI.md` (use `formatResearchPresentationMessage()`)
