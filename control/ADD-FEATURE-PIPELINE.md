...
Document skill outputs in feature folder as **self-contained selection-deck HTML pages** (`layout/selection/SELECTION-UI.md`). **Orchestrator presents each HTML file in chat with viewing instructions** after the stage — do not keep design decisions only in chat or on disk unseen.
