...
> `ARCHITECTURE.md`. The two are orthogonal: every feature has both an
> MVVM file layout *and* a set of decision fragments.
...
- Routes this document into every implementer dispatch via the `build` route.
