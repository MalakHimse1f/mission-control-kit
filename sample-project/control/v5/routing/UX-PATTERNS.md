...
## Worked example: personal-library-import / ux-source-picker-pattern
...
```
node lib/v5/cli/build-decision.mjs personal-library-import ux-source-picker-pattern
```

The CLI writes `features/personal-library-import/decisions/ux-source-picker-pattern.html` —
