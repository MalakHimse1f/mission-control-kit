...
## Worked example: personal-library-import / ui-surface-placement
...
```
node lib/v5/cli/build-decision.mjs personal-library-import ui-surface-placement
```

The CLI writes `features/personal-library-import/decisions/ui-surface-placement.html` —
